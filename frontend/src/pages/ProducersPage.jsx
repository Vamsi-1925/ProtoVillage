  ...
  return (
    ...
    >
      <form id="prod-form" onSubmit={submit} className="flex flex-col gap-5">
        {[
          ["Producer Name", <input key="n" value={name} onChange={(e) => setName(e.target.value)} placeholder="Lakshmi Devi" className="font-body text-body-md rounded-lg border border-outline-variant/70 dark:border-white/10 bg-white dark:bg-black text-on-surface dark:text-white px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-primary" />],
          ["Village", <input key="v" value={village} onChange={(e) => setVillage(e.target.value)} placeholder="Hampi North" className="font-body text-body-md rounded-lg border border-outline-variant/70 dark:border-white/10 bg-white dark:bg-black text-on-surface dark:text-white px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-primary" />],
